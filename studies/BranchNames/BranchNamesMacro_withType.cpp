...
int main(int argc, char* argv[])
{
    ...
    // else ifName = "/eos/uscms/store/user/agrummer/bbbb_ntuples/fullSubmission_2016_v27/SKIM_NMSSM_XYH_bbbb_MX_900_NANOAOD_v7_Full_MY_90/output/bbbbNtuple_0.root";
    else ifName = "/eos/uscms/store/user/agrummer/bbbb_ntuples/fullSubmission_2016_v27/SKIM_BTagCSV_Data/output/bbbbNtuple_98.root";
    BranchNamesMacro_withType(ifName);
    return 0;
}
