...
def compareUnrolled(dir_region, region, year, odir):
    odir = odir +year
...
#get histograms
    ...
    h_bkgModel_ttbar_down = gDirectory.Get(dir_3bScaled+"_"+dir_ttbar_down+"_"+dir_region+"_"+histname)
    ...
    h_ttbar = gDirectory.Get(dir_ttbar_3b_weights+"_"+dir_region+"_"+histname)
    #histogram names from outPlotter input to Combine
    #  h_data = ifile.Get("data_obs")
    #  h_bkgModel = ifile.Get("data_BTagCSV_dataDriven_kinFit")
    #  h_bkgModel_ttbar_up = ifile.Get("data_BTagCSV_dataDriven_kinFit_ttbar_up")
    #  h_bkgModel_ttbar_down = ifile.Get("data_BTagCSV_dataDriven_kinFit_ttbar_down")
    #  h_sig = ifile.Get("sig_NMSSM_bbbb_MX_600_MY_400")

    #plot histogram comparisons
    #  rootplot_2samp_ratio( h_3b_weights, h_4b,  year, region, varname, "orig_sig"   , odir, h_sig, h_sig )

    rootplot_2samp_ratio( h_3b_weights, h_4b,  year, region, varname, "orig_sig"   , odir, h_sig, h_bkgModel_ttbar_down )
    rootplot_2samp_ratio( h_bkgModel_ttbar_down, h_4b,  year, region, varname, "ttbarAdj_sig"   , odir, h_sig, h_3b_weights )
    rootplot_2samp_ratio( h_3b_weights, h_4b,  year, region, varname, "orig_ttbar"   , odir, h_ttbar, h_bkgModel_ttbar_down )
    rootplot_2samp_ratio( h_bkgModel_ttbar_down, h_4b,  year, region, varname, "ttbarAdj_ttbar"   , odir, h_ttbar, h_3b_weights )
...
for year in years:
    for region in regions:
        compareUnrolled(region[1], region[0], year, odir)
#  region = regions[0]
#  compareUnrolled(region[1], region[0], years[0], odir)

#  TTBAR adjusted BKG
#########################
#  odir = "VarPlots/UnrolledPlots_2022Mar18/"
#  year = "2016"
#  ifileName = "root://cmsxrootd.fnal.gov//store/user/agrummer/bbbb_limits/2022Mar18_fullBDT_MassWindow_TTBARasBKG_VR/HistogramFiles_2016/outPlotter_2016_sig_NMSSM_bbbb_MX_600_MY_400.root"
#  compareUnrolled(ifileName, year, odir)

#  year = "2017"
#  ifileName = "root://cmsxrootd.fnal.gov//store/user/agrummer/bbbb_limits/2022Mar18_fullBDT_MassWindow_TTBARasBKG_VR/HistogramFiles_2017/outPlotter_2017_sig_NMSSM_bbbb_MX_600_MY_400.root"
#  compareUnrolled(ifileName, year, odir)

#  year = "2018"
#  ifileName = "root://cmsxrootd.fnal.gov//store/user/agrummer/bbbb_limits/2022Mar18_fullBDT_MassWindow_TTBARasBKG_VR/HistogramFiles_2018/outPlotter_2018_sig_NMSSM_bbbb_MX_600_MY_400.root"
#  compareUnrolled(ifileName, year, odir)

#  #  # no TTBAR from Jan 26
### don't use anymore - different mass regions
#  #  #########################
#  #  #  odir = "VarPlots/UnrolledPlots_2022Mar18_noTTBAR/"
#  #  #  year = "2016"
#  #  #  ifileName = "root://cmsxrootd.fnal.gov//store/user/agrummer/bbbb_limits/VR_2022Jan26_mx600_my400a/HistogramFiles_2016/outPlotter_2016_sig_NMSSM_bbbb_MX_600_MY_400.root"
#  #  #  compareUnrolled(ifileName, year, odir)

#  #  #  year = "2017"
#  #  #  ifileName = "root://cmsxrootd.fnal.gov//store/user/agrummer/bbbb_limits/VR_2022Jan26_mx600_my400a/HistogramFiles_2017/outPlotter_2017_sig_NMSSM_bbbb_MX_600_MY_400.root"
#  #  #  compareUnrolled(ifileName, year, odir)

#  #  #  year = "2018"
#  #  #  ifileName = "root://cmsxrootd.fnal.gov//store/user/agrummer/bbbb_limits/VR_2022Jan26_mx600_my400a/HistogramFiles_2018/outPlotter_2018_sig_NMSSM_bbbb_MX_600_MY_400.root"
#  #  #  compareUnrolled(ifileName, year, odir)

# no TTBAR from Mar 18
#  #########################
#  odir = "VarPlots/UnrolledPlots_2022Mar18_noTTBAR_2/"
#  year = "2016"
#  ifileName = "root://cmsxrootd.fnal.gov//store/user/agrummer/bbbb_limits/2022Mar18_fullBDT_MassWindow_noTTBAR_VR/HistogramFiles_2016/outPlotter_2016_sig_NMSSM_bbbb_MX_600_MY_400.root"
#  compareUnrolled(ifileName, year, odir)

#  year = "2017"
#  ifileName = "root://cmsxrootd.fnal.gov//store/user/agrummer/bbbb_limits/2022Mar18_fullBDT_MassWindow_noTTBAR_VR/HistogramFiles_2017/outPlotter_2017_sig_NMSSM_bbbb_MX_600_MY_400.root"
#  compareUnrolled(ifileName, year, odir)

#  year = "2018"
#  ifileName = "root://cmsxrootd.fnal.gov//store/user/agrummer/bbbb_limits/2022Mar18_fullBDT_MassWindow_noTTBAR_VR/HistogramFiles_2018/outPlotter_2018_sig_NMSSM_bbbb_MX_600_MY_400.root"
#  compareUnrolled(ifileName, year, odir)
