...
TFile *ifile = new TFile(idir + "/outPlotter.root", "READ");
ifile->cd("sig_NMSSM_bbbb_MX_900_MY_80/selectionbJets_SignalRegion");
h1  = gDirectory->Get("sig_NMSSM_bbbb_MX_900_MY_80_selectionbJets_SignalRegion_HH_kinFit_m_H2_m_Rebinned_Unrolled");
return 0;
