...
set shortmess=aoO
badd +22 mlskim_NMSSM_XYH_bbbb/BuildBackgroundModel.py
badd +1 mlskim_NMSSM_XYH_bbbb/config/outputskim_2016_Full_kinFit.cfg
badd +12 mlskim_NMSSM_XYH_bbbb/config/outputskim_2017_Full_kinFit.cfg
