...
def doPlots():
    ...
    anaText.DrawLatex(0.92, 0.86, "%s model" % (algorithm) )
    anaText.DrawLatex(0.92, 0.82, "%s" % (msg) )
    anaText.DrawLatex(0.92, 0.74, "%s, %s" % (config["PlotLabel"], config["year"]) )
    ...
    pvalText.DrawLatex(0.92, 0.78, "toys = %d" % nToys)
