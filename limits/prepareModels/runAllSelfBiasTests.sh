...
for year in "${yearList[@]}"; do
    ...
    python prepareModels/runFullSelfBiasTest.py --config prepareModels/config/SelfBiasTest_${year}.cfg --signal sig_NMSSM_bbbb_MX_900_MY_500   --injRange 3 --group 2
    python prepareModels/runFullSelfBiasTest.py --config prepareModels/config/SelfBiasTest_${year}.cfg --signal sig_NMSSM_bbbb_MX_1000_MY_125  --injRange 1 --group 2
    python prepareModels/runFullSelfBiasTest.py --config prepareModels/config/SelfBiasTest_${year}.cfg --signal sig_NMSSM_bbbb_MX_1200_MY_800  --injRange 2 --group 3
    python prepareModels/runFullSelfBiasTest.py --config prepareModels/config/SelfBiasTest_${year}.cfg --signal sig_NMSSM_bbbb_MX_1400_MY_500  --injRange 1 --group 3
