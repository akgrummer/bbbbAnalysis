...
outputFileNameDATA           = 'higgsCombineTest.GoodnessOfFit.mH125.root'
outputFileNameTOYS           = 'higgsCombineTest.GoodnessOfFit.mH125.{0}.root'
...
gofFileFolderProto      = baseFolder + '/gofFiles_{0}/'
...
tarName      = 'GoFCalculator.tar.gz' #%s_tar.tgz' % cmssw_version
