...
void modifyPlotForControlTest(std::string inputFileName)
{
    ...
    std::string controlRegion = "selectionbJets_ControlRegionBlinded";
    ...
    TH1F* data       = getHistogramFromFile<TH1F>(inputFile, getFullHistName(dataDataset, controlRegion, variable               ));
    TH1F* bkgNominal = getHistogramFromFile<TH1F>(inputFile, getFullHistName(bkgDataset , controlRegion, variable               ));
    /* TH1F* bkgTTBARup   = getHistogramFromFile<TH1F>(inputFile, getFullHistName(bkgDatasetTTBARup , controlRegion, variable               )); */
    /* TH1F* bkgTTBARdown = getHistogramFromFile<TH1F>(inputFile, getFullHistName(bkgDatasetTTBARdown , controlRegion, variable               )); */
    TH1F* bkgUp      = getHistogramFromFile<TH1F>(inputFile, getFullHistName(bkgDataset , controlRegion, variable, variationUp  ));
    TH1F* bkgDown    = getHistogramFromFile<TH1F>(inputFile, getFullHistName(bkgDataset , controlRegion, variable, variationDown));
...
void modifyAllPlotForControlTest(std::string tag = "", std::string tagDir = "")
{
