...
def rootplot_2samp_ratio( h1, h2, year, region, var, tag, odir, href ):
    ...
    plotlabels.DrawLatexNDC(0.35, 0.85, "gen matched")
    plotlabels.SetTextFont(43)
    plotlabels.SetTextSize(15)
    plotlabels.SetTextAlign(32);
    plotlabels.DrawLatexNDC(0.9, 0.69, "without kinFit Mean = {0:.2f}".format(h1.GetMean()))
    plotlabels.DrawLatexNDC(0.9, 0.65, "with kinFit Mean = {0:.2f}".format(h2.GetMean()))
    plotlabels.DrawLatexNDC(0.9, 0.61, "without kinFit Std. Dev. = {0:.2f}".format(h1.GetStdDev()))
    plotlabels.DrawLatexNDC(0.9, 0.57, "with kinFit Std. Dev. = {0:.2f}".format(h2.GetStdDev()))
...
#  # data plots
    ...
    # varname1 = "H1_pt"
    # varname2 = "H1_kinFit_pt"
    # varname1 = "H1_b1_ptRegressed"
    # varname2 = "H1_b1_kinFit_ptRegressed"
    varname1 = "H1_b2_ptRegressed"
    varname2 = "H1_b2_kinFit_ptRegressed"
...
odir = "VarPlots/2023Feb20_signalHpt/"
