...
def rootplot_2samp_ratio( h1, h2, year, region, var, tag, odir, href ):
    ...
    leg.AddEntry(h3, "3b data unc.", "le")
    leg.AddEntry(h4, "4b data unc.", "f")
...
##################################################
    ...
    rootplot_2Dhist(h_sig_MX_600_MY_400, "HH_kinFit_m", "H2_m", odir, "sig4b_600_MY_400_zoom", region, xRange=[150.,800.], yRange=[0.,600.])
    rootplot_2Dhist(h_sig_MX_300_MY_150, "HH_kinFit_m", "H2_m", odir, "sig4b_300_MY_150", region)
    rootplot_2Dhist(h_sig_MX_300_MY_150, "HH_kinFit_m", "H2_m", odir, "sig4b_300_MY_150_zoom", region, xRange=[150.,800.], yRange=[0.,600.])
    rootplot_2Dhist(h_sig_MX_300_MY_60, "HH_kinFit_m", "H2_m", odir, "sig4b_300_MY_60", region)
    rootplot_2Dhist(h_sig_MX_300_MY_60, "HH_kinFit_m", "H2_m", odir, "sig4b_300_MY_60_zoom", region, xRange=[150.,800.], yRange=[0.,600.])
...
# ##################################################
    ...
    rootplot_2Dhist(h_3b_weights_mXmY2D, "HH_kinFit_m", "H2_m", odir, "model_massWindow", region, xRange=[0.,800.], yRange=[0.,600.])
    ...
    rootplot_2Dhist(h_4b_mXmY2D, "HH_kinFit_m", "H2_m", odir, "target_massWindow", region, xRange=[150.,800.], yRange=[0.,600.])
    ...
    rootplot_2Dhist(h_ratio, "HH_kinFit_m", "H2_m", odir, "ratio_threshold_massWindow", region, xRange=[300.,800.], yRange=[100.,600.], zRange=[1.3,2.1])
    rootplot_2Dhist(h_ratio, "HH_kinFit_m", "H2_m", odir, "ratio", region, zRange=[0.,8.])
    rootplot_2Dhist(h_ratio, "HH_kinFit_m", "H2_m", odir, "ratio_massWindow", region, zRange=[0.,2.5], xRange=[150.,800.], yRange=[0.,600.])
    ...
    rootplot_2Dhist(hsigma, "HH_kinFit_m", "H2_m", odir, "sigma_abs_massWindow", region, zRange=[-2.5,2.5], xRange=[150.,800.], yRange=[0.,600.])
           #  h1.GetZaxis().SetRangeUser(3, 4.)
           #  h1.GetZaxis().SetRangeUser(2, 4.)
           #  h1.GetZaxis().SetRangeUser(1.5, 4.)
           #  h1.GetZaxis().SetRangeUser(-2,2)
