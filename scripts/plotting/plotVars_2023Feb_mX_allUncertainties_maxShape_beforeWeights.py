...
def rootplot_2samp_ratio( h1, h2, year, region, var, tag, odir, href, h_up, h_down ):
    ...
    for i in range(h3.GetSize()):
        ...
        if (h3.GetBinContent(i)>0):
            ...
            bin_err_up_1 = math.sqrt(stat_err**2 + shape_err_up**2 + norm_err**2)/h3.GetXaxis().GetBinWidth(i)
            bin_err_down_1 = math.sqrt(stat_err**2 + shape_err_down**2 + norm_err**2)/h3.GetXaxis().GetBinWidth(i)
    ...
    leg.AddEntry(h3, "3b data unc. (stat)", "f")
...
#  # data plots
    ...
    #  varname = "H1_b1_kinFit_ptRegressed"
        ...
        # rootplot_2samp_ratio( h_3b, h_4b, year, region, varname, "orig", odir, h_3b, h_3b, h_3b)
        rootplot_2samp_ratio( h_3b_weights, h_3b, year, region, varname, "weights", odir, h_3b, h_3b, h_3b)
##################################################
...
odir = "VarPlots/2023Apr18_3bsigweights/"
...
# ##################################################
# for data
# including signal region but only plotting 3b sample
