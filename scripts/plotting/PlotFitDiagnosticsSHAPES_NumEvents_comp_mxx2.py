...
def makePlot(labels, ibinMap1, ibinMap2, ibinMap3, inputFile1, inputFile2,  inputFile3):
  ...
  legName2 = "mY bins x2"
  legName3 = "mY bins x2, mX bins x2"
...
for afittype in allfittypes:
    for year in years:
        ...
        iodir3 = "/uscms/homes/a/agrummer/nobackup/DiHiggs_v2/CMSSW_10_2_5/src/bbbbAnalysis/VarPlots/rootHists/fullSubmission_2022Nov/{0}DataPlots_2023Jul5_binMYx2_MXx2_loc/".format(year)
