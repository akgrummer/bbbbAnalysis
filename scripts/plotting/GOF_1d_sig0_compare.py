...
def rootplot_1Dhist(h1, h2, year, idir, tag):
    ...
    elif "binMYx2" in args.tag2 and "ncMCStats" in args.tag2:
        h2Label = "new Hourglass and mY bins x2"
    elif "binMYx2" in args.tag2:
        h2Label = "mY bins x2"
...
def makePlotsPerYear(year, pvalFile, pvalFile2):
  ...
  rootplot_1Dhist(hGOF, hGOF2, year, idir, args.tag  + "_"+args.tag2 + "_"+args.algo + args.zoom)
