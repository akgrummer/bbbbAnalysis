...
int main(int argc, char *argv[])
{
    ...
    std::pair<float, float> massGroup = theMassGroupList[groupNum];
        ...
        oFileText.open(inputFileName.substr(0,inputFileName.find(".root")) + "_UnrollLocation_massGroup" + std::to_string(groupNum) + ".txt", std::ofstream::out);
        oFileTextData.open(inputFileName.substr(0,inputFileName.find(".root")) + "_UnrollLocationDATA_massGroup" + std::to_string(groupNum) + ".txt", std::ofstream::out);
