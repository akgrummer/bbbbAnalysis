...
void modifyAllPlotForValidationTest_fullPlane(std::string tag = "", std::string tagDir = "")
{
    std::vector<int> yearList        {2016, 2017, 2018};

    for(const auto year : yearList)
    {
            std::string inputFileName = "VarPlots/rootHists/" + tagDir + std::to_string(year) + "DataPlots_" + tag + "/outPlotter_fullPlane"+ ".root";
