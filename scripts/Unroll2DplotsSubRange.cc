...
// ./Unroll2DplotsSubRange ..//2016DataPlots_NMSSM_XYH_bbbb_triggerMatchedBKGNorm/outPlotter.root \
...
//g++  -std=c++17 -I `root-config --incdir` -o Unroll2DplotsSubRange Unroll2DplotsSubRange.cc `root-config --libs` -O3 && ./Unroll2DplotsSubRange ../plotResults/2016DataPlots_NMSSM_XYH_bbbb/outPlotter.root data_BTagCSV_BackgroundTriggerMatched selectionbJetsAndTrigger_SignalRegion HH_m_H2_m

// ./scripts/Unroll2DplotsSubRange 2016DataPlots_NMSSM_XYH_bbbb_PtRegressedAndHigherLevel_VCR_30_VSR_10/outPlotter.root data_BTagCSV_dataDriven selectionbJetsAndTrigger_3bTag_SignalRegion HH_m_H2_m selectionbJetsAndTrigger_3bTag_ControlRegionBlinded selectionbJetsAndTrigger_3bTag_SideBandBlinded selectionbJetsAndTrigger_4bTag_ControlRegionBlinded selectionbJetsAndTrigger_4bTag_SideBandBlinded selectionbJetsAndTrigger_4bTag_SignalRegion
// ./scripts/Unroll2DplotsSubRange 2016DataPlots_NMSSM_XYH_bbbb_PtRegressedAndHigherLevel_VCR_30_VSR_10/outPlotter.root data_BTagCSV_dataDriven_noTrigMatch selectionbJets_3bTag_SignalRegion HH_m_H2_m selectionbJets_3bTag_ControlRegionBlinded selectionbJets_3bTag_SideBandBlinded selectionbJets_4bTag_ControlRegionBlinded selectionbJets_4bTag_SideBandBlinded selectionbJets_4bTag_SignalRegion
// ./scripts/Unroll2DplotsSubRange 2016DataPlots_NMSSM_XYH_bbbb_Fast/outPlotter.root data_BTagCSV_dataDriven selectionbJets_SignalRegion HH_m_H2_m selectionbJets_ControlRegionBlinded selectionbJets_SideBandBlinded
